...
def bce_loss(input, target):
    ...
    # ***** FIXED LINE BELOW: Squeeze both input and target *****
...
def discriminator_loss(logits_real, logits_fake):
    ...
    # Targets: Real = 1, Fake = 0
    # We use .type(dtype) to ensure they are on the correct device (GPU/CPU)
...
def generator_loss(logits_fake):
    ...
    # Generator wants to fool D, so target labels are 1
